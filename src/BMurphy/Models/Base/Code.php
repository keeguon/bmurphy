...
/**
 * Base class of the BMurphy\Models\Code entity.
 */
abstract class Code implements \ArrayAccess
{
    protected $id;
    protected $client_id;
    protected $user_id;
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setTableName('codes');
        $metadata->setCustomRepositoryClass('BMurphy\Models\CodeRepository');
    ...
    {
        return static::entityManager()->getRepository('BMurphy\Models\Code');
    }
