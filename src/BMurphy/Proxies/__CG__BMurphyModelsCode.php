 ...
 */
class Code extends \BMurphy\Models\Code implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'client_id', 'user_id', 'code', 'valid', 'created', 'updated', 'client', 'user');
    }
